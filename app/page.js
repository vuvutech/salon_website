      ...
      <>{ /* Hero */}
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 className="block text-2xl font-bold text-gray-800 sm:text-3xl lg:text-5xl  dark:text-white">Experience Our full range of   <span className="text-teal-600">hairdressing </span>services</h1>
              <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">Passionate about hair care and teaching you how to maintain your fabulous new look with the best products and great advice.</p>
              ...
              <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                ...
                <div className="py-5">
                  <div className="flex space-x-1">
                    <svg className="size-4 text-gray-800 dark:text-gray-200" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
