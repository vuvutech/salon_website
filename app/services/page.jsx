		...
		<section
			...
			<div className='mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center'>
				...
				<p className='max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7'>
					The product can personalize user experiences by
					understanding individual preferences and tailoring
					recommendations or content based on user behavior and
					historical data.
				</p>
			</div>
				...
				<div className='relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2'>
					<div className='flex h-[180px] flex-col justify-between rounded-md p-6'>
						...
						<div className='space-y-2'>
							...
							<p className='text-sm text-muted-foreground'>
								UI components built using Radix UI and styled
								with Tailwind CSS.
							</p>
						</div>
					</div>
