...
const Terms = () => {
  return (
    <section className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto dark:bg-teal-800 ">
      <div className="rounded-3xl p-2 md:p-8 bg-teal-50 space-y-4">
        <>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Elsie Hair
                Salon, 7 Deodar St, Mayberry Park, Alberton, 1481, South Africa.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Elsie Hair Salon, accessible
                from{" "}
                <a
                  href="https://www.elsiehairsalon.co.za/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.elsiehairsalon.co.za/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: info@elsiehairsalon.co.za</li>
          </ul>
        </>
      </div>
    </section>
